        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PageDescription = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateShipping = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ...
                    DateOfPayement = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BookLanguageId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BookItems_booklanguage_BookLanguageId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_orderDetails_BookItems_BookItemId",
                        column: x => x.BookItemId,
                        principalTable: "BookItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookItems_BookLanguageId",
                table: "BookItems",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Carts_BookitemId",
                table: "Carts",
                column: "BookitemId");

            migrationBuilder.CreateIndex(
                name: "IX_orderDetails_BookItemId",
                table: "orderDetails",
                column: "BookItemId");
